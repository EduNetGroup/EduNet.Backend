...
namespace EduNet.Backend.Data.Migrations
{
    ...
    [Migration("20240426172714_UserEntityUpdatedMigrations")]
    partial class UserEntityUpdatedMigrations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduNet.Backend.Domain.Entities.Students.Student", b =>
                {
                    b.HasOne("EduNet.Backend.Domain.Entities.Users.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("EduNet.Backend.Domain.Entities.Students.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduNet.Backend.Domain.Entities.Teachers.Teacher", b =>
                {
                    b.HasOne("EduNet.Backend.Domain.Entities.Users.User", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("EduNet.Backend.Domain.Entities.Teachers.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
